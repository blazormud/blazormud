...
namespace BlazorMUD.Server.Data.Migrations
{
    ...
    [Migration("20210724013625_AddRegion")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorMUD.Core.Models.Region", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BlazorMUD.Server.Models.ApplicationRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BlazorMUD.Server.Models.ApplicationUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BlazorMUD.Core.Models.AreaTemplate", b =>
                {
                    b.HasOne("BlazorMUD.Core.Models.Region", "Region")
                        .WithMany("Areas")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("BlazorMUD.Server.Models.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("BlazorMUD.Server.Models.ApplicationUser", null)
                        .WithMany()
