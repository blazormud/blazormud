...
namespace BlazorMUD.Core.Engine
{
    public class Link
    {
        ...
        {
            get => Flags.IsSet(LinkFlags.IsLockable);
            set => Flags = value ? Flags.Set(LinkFlags.IsLockable) : Flags.Unset(LinkFlags.IsLockable);
        }
    ...
    public enum LinkFlags : uint
    {
        ...
        IsLockable = 0b_0000_0000_0000_0000_0000_0000_0000_0001,
    ...
    public static partial class BitFlagEnumExtensions
    {
        ...
        public static LinkFlags Set(this LinkFlags @this, LinkFlags flag) => @this |= flag;
        /// <summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LinkFlags Unset(this LinkFlags @this, LinkFlags flag) => @this &= ~flag;
        /// <summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LinkFlags Toggle(this LinkFlags @this, LinkFlags flag) => @this ^= flag;
        /// <summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool IsSet(this LinkFlags @this, LinkFlags flag) => (@this & flag) == flag;
    }
