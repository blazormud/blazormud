...
namespace BlazorMUD.Core.Engine
{
    public class Timezone
    {
        ...
        public TimezoneFlags Flags { get; set; }
    }

    [Flags]
    public enum TimezoneFlags : uint
    {
    ...
    public static partial class BitFlagEnumExtensions
    {
        ...
        public static TimezoneFlags Set(this TimezoneFlags @this, TimezoneFlags flag) => @this |= flag;
        /// <summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TimezoneFlags Unset(this TimezoneFlags @this, TimezoneFlags flag) => @this &= ~flag;
        /// <summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TimezoneFlags Toggle(this TimezoneFlags @this, TimezoneFlags flag) => @this ^= flag;
        /// <summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool IsSet(this TimezoneFlags @this, TimezoneFlags flag) => (@this & flag) == flag;
    }
