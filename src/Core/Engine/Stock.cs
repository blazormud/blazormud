...
namespace BlazorMUD.Core.Engine
{
    public class Stock
    {
        ...
        public StockFlags Flags { get; set; }

        public Item Item { get; set; }
        public int Count { get; set; }
        public float Profit { get; set; }

        public int Price => Convert.ToInt32(Math.Ceiling(Item.Price * Profit));
    }

    [Flags]
    public enum StockFlags : uint
    {
    ...
    public static partial class BitFlagEnumExtensions
    {
        ...
        public static StockFlags Set(this StockFlags @this, StockFlags flag) => @this |= flag;
        /// <summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static StockFlags Unset(this StockFlags @this, StockFlags flag) => @this &= ~flag;
        /// <summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static StockFlags Toggle(this StockFlags @this, StockFlags flag) => @this ^= flag;
        /// <summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool IsSet(this StockFlags @this, StockFlags flag) => (@this & flag) == flag;
    }
