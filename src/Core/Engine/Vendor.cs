...
namespace BlazorMUD.Core.Engine
{
    public class Vendor
    {
        ...
        public VendorFlags Flags { get; set; }

        public IEnumerable<Stock> Inventory { get; set; }
    }

    [Flags]
    public enum VendorFlags : uint
    {
    ...
    public static partial class BitFlagEnumExtensions
    {
        ...
        public static VendorFlags Set(this VendorFlags @this, VendorFlags flag) => @this |= flag;
        /// <summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VendorFlags Unset(this VendorFlags @this, VendorFlags flag) => @this &= ~flag;
        /// <summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VendorFlags Toggle(this VendorFlags @this, VendorFlags flag) => @this ^= flag;
        /// <summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool IsSet(this VendorFlags @this, VendorFlags flag) => (@this & flag) == flag;
    }
